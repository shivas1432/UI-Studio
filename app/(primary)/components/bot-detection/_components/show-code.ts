...
export const cliscript = "add https://UIStudio.in/registry/bot-detection.json";
...
export const democode = `import BotDetection from '@/components/UIStudio/bot-detection';
