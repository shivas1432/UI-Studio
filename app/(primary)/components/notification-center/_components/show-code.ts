...
export const cliscript = "add https://UIStudio.in/registry/notification-center.json";
...
export const democode = `import NotificationCenter from '@/components/UIStudio/notification-center';
