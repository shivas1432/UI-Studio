...
export const cliscript = "add https://UIStudio.in/registry/security-card.json";
...
export const democode = `import SecurityCard from '@/components/UIStudio/security-card';
