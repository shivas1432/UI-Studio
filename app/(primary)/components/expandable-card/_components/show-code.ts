...
export const cliscript = "add https://UIStudio.in/registry/expandable-card.json";
...
export const democode = `import ExpandableCard, { CardItem, Firebase, MetaMask, Upstash} from '@/components/UIStudio/expandable-card';
