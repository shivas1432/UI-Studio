...
export const cliscript = "add https://UIStudio.in/registry/framework-agnostic.json";
...
export const democode = `import FrameworkAgnostic from '@/components/UIStudio/framework-agnostic';
