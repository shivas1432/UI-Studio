...
export const cliscript = "add https://UIStudio.in/registry/animated-form.json";
...
export const democode = `import AnimatedForm from '@/components/UIStudio/animated-form';
