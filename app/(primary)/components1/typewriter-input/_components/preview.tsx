...
import TypewriterInput from "@/Components1/typewriter-input";

const TypewriterInputPreview = () => {
  ...
  return (
    <MainContentContainer>
      ...
      <PropsTable propsData={typewriterInputProps} />
      <ComponentNavigation previous={previous} next={next} />
    </MainContentContainer>
  );
};

export default TypewriterInputPreview;