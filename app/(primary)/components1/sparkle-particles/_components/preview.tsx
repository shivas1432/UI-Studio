...
import SparkleParticles from "@/Components1/sparkle-particles";

const SparkleParticlesPreview = () => {
  ...
  return (
    <MainContentContainer>
      ...
      <PropsTable propsData={sparkleParticlesProps} />
      <ComponentNavigation previous={previous} next={next} />
    </MainContentContainer>
  );
};

export default SparkleParticlesPreview;