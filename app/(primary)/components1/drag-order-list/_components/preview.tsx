...
import DragOrderList from "@/Components1/drag-order-list";

const DragOrderListPreview = () => {
  ...
  return (
    <MainContentContainer>
      ...
      <PropsTable propsData={dragOrderListProps} />
      <ComponentNavigation previous={previous} next={next} />
    </MainContentContainer>
  );
};

export default DragOrderListPreview;