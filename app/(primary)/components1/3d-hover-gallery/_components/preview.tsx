...
import ThreeDHover Gallery from "@/Components1/3d-hover-gallery";

const ThreeDHover GalleryPreview = () => {
  ...
  return (
    <MainContentContainer>
      ...
      <PropsTable propsData={threeDHover Gallery} />
      <ComponentNavigation previous={previous} next={next} />
    </MainContentContainer>
  );
};

export default ThreeDHover GalleryPreview;