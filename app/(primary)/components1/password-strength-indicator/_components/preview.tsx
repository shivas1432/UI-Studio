...
import PasswordStrengthIndicator from "@/Components1/password-strength-indicator";

const PasswordStrengthIndicatorPreview = () => {
  ...
  return (
    <MainContentContainer>
      ...
      <PropsTable propsData={passwordStrengthIndicatorProps} />
      <ComponentNavigation previous={previous} next={next} />
    </MainContentContainer>
  );
};

export default PasswordStrengthIndicatorPreview;