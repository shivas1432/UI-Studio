...
import InteractiveGradientCard from "@/Components1/interactive-gradient-card";

const InteractiveGradientCardPreview = () => {
  ...
  return (
    <MainContentContainer>
      ...
      <PropsTable propsData={interactiveGradientCardProps} />
      <ComponentNavigation previous={previous} next={next} />
    </MainContentContainer>
  );
};

export default InteractiveGradientCardPreview;