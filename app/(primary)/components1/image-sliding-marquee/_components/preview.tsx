...
import ImageSlidingMarquee from "@/Components1/image-sliding-marquee";

const ImageSlidingMarqueePreview = () => {
  ...
  return (
    <MainContentContainer>
      ...
      <PropsTable propsData={imageSlidingMarqueeProps} />
      <ComponentNavigation previous={previous} next={next} />
    </MainContentContainer>
  );
};

export default ImageSlidingMarqueePreview;