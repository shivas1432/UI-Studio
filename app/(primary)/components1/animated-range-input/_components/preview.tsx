...
import AnimatedRangeInput from "@/Components1/animated-range-input";

const AnimatedRangeInputPreview = () => {
  ...
  return (
    <MainContentContainer>
      ...
      <PropsTable propsData={animatedRangeInputProps} />
      <ComponentNavigation previous={previous} next={next} />
    </MainContentContainer>
  );
};

export default AnimatedRangeInputPreview;