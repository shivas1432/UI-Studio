...
import StripesBackground from "@/Components1/stripes-background";

const StripesBackgroundPreview = () => {
  ...
  return (
    <MainContentContainer>
      ...
      <PropsTable propsData={stripesBackgroundProps} />
      <ComponentNavigation previous={previous} next={next} />
    </MainContentContainer>
  );
};

export default StripesBackgroundPreview;