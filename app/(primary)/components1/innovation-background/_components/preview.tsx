...
import InnovationBackground from "@/Components1/innovation-background";

const InnovationBackgroundPreview = () => {
  ...
  return (
    <MainContentContainer>
      ...
      <PropsTable propsData={innovationBackgroundProps} />
      <ComponentNavigation previous={previous} next={next} />
    </MainContentContainer>
  );
};

export default InnovationBackgroundPreview;