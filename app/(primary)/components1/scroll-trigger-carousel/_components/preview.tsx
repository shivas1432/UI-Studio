...
import ScrollTriggerCarousel from "@/Components1/scroll-trigger-carousel";

const ScrollTriggerCarouselPreview = () => {
  ...
  return (
    <MainContentContainer>
      ...
      <PropsTable propsData={scrollTriggerCarouselProps} />
      <ComponentNavigation previous={previous} next={next} />
    </MainContentContainer>
  );
};

export default ScrollTriggerCarouselPreview;