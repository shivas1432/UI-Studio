...
import CanvasConfettiCursor from "@/Components1/canvas-confetti-cursor";

const CanvasConfettiCursorPreview = () => {
  ...
  return (
    <MainContentContainer>
      ...
      <PropsTable propsData={canvasConfettiCursorProps} />
      <ComponentNavigation previous={previous} next={next} />
    </MainContentContainer>
  );
};

export default CanvasConfettiCursorPreview;