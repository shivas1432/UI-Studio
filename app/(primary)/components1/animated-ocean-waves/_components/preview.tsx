...
import AnimatedOceanWaves from "@/Components1/animated-ocean-waves";

const AnimatedOceanWavesPreview = () => {
  ...
  return (
    <MainContentContainer>
      ...
      <PropsTable propsData={animatedOceanWavesProps} />
      <ComponentNavigation previous={previous} next={next} />
    </MainContentContainer>
  );
};

export default AnimatedOceanWavesPreview;