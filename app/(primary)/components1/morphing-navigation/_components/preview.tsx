...
import MorphingNavigation from "@/Components1/morphing-navigation";

const MorphingNavigationPreview = () => {
  ...
  return (
    <MainContentContainer>
      ...
      <PropsTable propsData={morphingNavigationProps} />
      <ComponentNavigation previous={previous} next={next} />
    </MainContentContainer>
  );
};

export default MorphingNavigationPreview;