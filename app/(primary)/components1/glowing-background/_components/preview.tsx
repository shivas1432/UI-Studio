...
import GlowingBackground from "@/Components1/glowing-background";

const GlowingBackgroundPreview = () => {
  ...
  return (
    <MainContentContainer>
      ...
      <PropsTable propsData={glowingBackgroundProps} />
      <ComponentNavigation previous={previous} next={next} />
    </MainContentContainer>
  );
};

export default GlowingBackgroundPreview;