...
import DynamicNavigation from "@/Components1/dynamic-navigation";

const DynamicNavigationPreview = () => {
  ...
  return (
    <MainContentContainer>
      ...
      <PropsTable propsData={dynamicNavigationProps} />
      <ComponentNavigation previous={previous} next={next} />
    </MainContentContainer>
  );
};

export default DynamicNavigationPreview;