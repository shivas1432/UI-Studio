...
import CodeHoverCards from "@/Components1/code-hover-cards";

const CodeHoverCardsPreview = () => {
  ...
  return (
    <MainContentContainer>
      ...
      <PropsTable propsData={codeHoverCardsProps} />
      <ComponentNavigation previous={previous} next={next} />
    </MainContentContainer>
  );
};

export default CodeHoverCardsPreview;