...
import ScrollCarousel from "@/Components1/scroll-carousel";

const ScrollCarouselPreview = () => {
  ...
  return (
    <MainContentContainer>
      ...
      <PropsTable propsData={scrollCarouselProps} />
      <ComponentNavigation previous={previous} next={next} />
    </MainContentContainer>
  );
};

export default ScrollCarouselPreview;