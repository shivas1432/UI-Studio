...
import HamburgerMenuOverlay from "@/Components1/hamburger-menu-overlay";

const HamburgerMenuOverlayPreview = () => {
  ...
  return (
    <MainContentContainer>
      ...
      <PropsTable propsData={hamburgerMenuOverlayProps} />
      <ComponentNavigation previous={previous} next={next} />
    </MainContentContainer>
  );
};

export default HamburgerMenuOverlayPreview;