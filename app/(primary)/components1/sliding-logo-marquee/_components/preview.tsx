...
import SlidingLogoMarquee from "@/Components1/sliding-logo-marquee";

const SlidingLogoMarqueePreview = () => {
  ...
  return (
    <MainContentContainer>
      ...
      <PropsTable propsData={slidingLogoMarqueeProps} />
      <ComponentNavigation previous={previous} next={next} />
    </MainContentContainer>
  );
};

export default SlidingLogoMarqueePreview;