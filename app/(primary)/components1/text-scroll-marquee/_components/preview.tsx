...
import TextScrollMarquee from "@/Components1/text-scroll-marquee";

const TextScrollMarqueePreview = () => {
  ...
  return (
    <MainContentContainer>
      ...
      <PropsTable propsData={textScrollMarqueeProps} />
      <ComponentNavigation previous={previous} next={next} />
    </MainContentContainer>
  );
};

export default TextScrollMarqueePreview;