...
import AnimatedNotification from "@/Components1/animated-notification";

const AnimatedNotificationPreview = () => {
  ...
  return (
    <MainContentContainer>
      ...
      <PropsTable propsData={animatedNotificationProps} />
      <ComponentNavigation previous={previous} next={next} />
    </MainContentContainer>
  );
};

export default AnimatedNotificationPreview;