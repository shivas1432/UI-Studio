...
import InteractiveCardGallery from "@/Components1/interactive-card-gallery";

const InteractiveCardGalleryPreview = () => {
  ...
  return (
    <MainContentContainer>
      ...
      <PropsTable propsData={interactiveCardGalleryProps} />
      <ComponentNavigation previous={previous} next={next} />
    </MainContentContainer>
  );
};

export default InteractiveCardGalleryPreview;