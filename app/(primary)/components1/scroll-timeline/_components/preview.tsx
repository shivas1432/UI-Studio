...
import ScrollTimeline from "@/Components1/scroll-timeline";

const ScrollTimelinePreview = () => {
  ...
  return (
    <MainContentContainer>
      ...
      <PropsTable propsData={scrollTimelineProps} />
      <ComponentNavigation previous={previous} next={next} />
    </MainContentContainer>
  );
};

export default ScrollTimelinePreview;