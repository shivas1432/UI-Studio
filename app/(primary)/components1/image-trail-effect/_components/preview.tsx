...
import ImageTrailEffect from "@/Components1/image-trail-effect";

const ImageTrailEffectPreview = () => {
  ...
  return (
    <MainContentContainer>
      ...
      <PropsTable propsData={imageTrailEffectProps} />
      <ComponentNavigation previous={previous} next={next} />
    </MainContentContainer>
  );
};

export default ImageTrailEffectPreview;