...
import WoofyHoverImage from "@/Components1/woofy-hover-image";

const WoofyHoverImagePreview = () => {
  ...
  return (
    <MainContentContainer>
      ...
      <PropsTable propsData={woofyHoverImageProps} />
      <ComponentNavigation previous={previous} next={next} />
    </MainContentContainer>
  );
};

export default WoofyHoverImagePreview;