...
import SeasonalHoverCards from "@/Components1/seasonal-hover-cards";

const SeasonalHoverCardsPreview = () => {
  ...
  return (
    <MainContentContainer>
      ...
      <PropsTable propsData={seasonalHoverCardsProps} />
      <ComponentNavigation previous={previous} next={next} />
    </MainContentContainer>
  );
};

export default SeasonalHoverCardsPreview;