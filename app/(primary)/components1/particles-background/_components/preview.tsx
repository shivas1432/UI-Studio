...
import ParticlesBackground from "@/Components1/particles-background";

const ParticlesBackgroundPreview = () => {
  ...
  return (
    <MainContentContainer>
      ...
      <PropsTable propsData={particlesBackgroundProps} />
      <ComponentNavigation previous={previous} next={next} />
    </MainContentContainer>
  );
};

export default ParticlesBackgroundPreview;