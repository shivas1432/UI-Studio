...
import ParticleOrbitEffect from "@/Components1/particle-orbit-effect";

const ParticleOrbitEffectPreview = () => {
  ...
  return (
    <MainContentContainer>
      ...
      <PropsTable propsData={particleOrbitEffectProps} />
      <ComponentNavigation previous={previous} next={next} />
    </MainContentContainer>
  );
};

export default ParticleOrbitEffectPreview;