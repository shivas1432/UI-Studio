...
import SparkleNavbar from "@/Components1/sparkle-navbar";

const SparkleNavbarPreview = () => {
  ...
  return (
    <MainContentContainer>
      ...
      <PropsTable propsData={sparkleNavbarProps} />
      <ComponentNavigation previous={previous} next={next} />
    </MainContentContainer>
  );
};

export default SparkleNavbarPreview;