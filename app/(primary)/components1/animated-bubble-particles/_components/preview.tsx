...
import AnimatedBubbleParticles from "@/Components1/animated-bubble-particles";

const AnimatedBubbleParticlesPreview = () => {
  ...
  return (
    <MainContentContainer>
      ...
      <PropsTable propsData={animatedBubbleParticlesProps} />
      <ComponentNavigation previous={previous} next={next} />
    </MainContentContainer>
  );
};

export default AnimatedBubbleParticlesPreview;