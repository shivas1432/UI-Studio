    ...
    <article className="container mx-auto max-w-6xl py-6 lg:pl-8">
      <div className="space-y-8">
        ...
        <div className="space-y-6 text-base leading-relaxed">
          <p>
            UI Studio is a collection of beautifully designed, customizable
          ...
          <div className="pt-4">
            ...
            <p className="mb-4">
              Unlike traditional libraries, UI Studio is not available as an
            ...
            >
              Use UI Studio as a foundation to build your own tailored component
              libraries.
            </p>
          </div>
        </div>
